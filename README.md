...
Welcome to the Collaborative Whiteboard App! This application allows multiple users to draw, collaborate, and share ideas on a virtual whiteboard while minting and managing NFTs.


Please leave a ⭐ if you like it.

![whiteboard-app-preview - Copy](https://github.com/user-attachments/assets/ce7a8bf8-1416-41ce-8584-21fc39305501)


## Features

- Real-time collaboration on the whiteboard.
- Users can draw and share their ideas instantly.
- Mint unique drawings as NFTs using Moralis and Solidity.
- Upload drawings to IPFS for decentralized storage.
- User authentication and wallet connection through Moralis.
...
- **React**: The framework used to create the frontend of the application.
- **TypeScript**: A typed superset of JavaScript used in the frontend for type safety.
- **Solidity**: Used for creating the NFT smart contract.
- **Moralis**: For wallet connectivity, uploading drawings to IPFS, and minting NFTs.
- **CSS**: For styling the application.
- **Node.js**: Used to build the backend server.
- **Socket.io**: For enabling real-time communication between users on the whiteboard.
...
1. Clone the repository:
   ...
   - git clone https://github.com/yourusername/collaborative-whiteboard-app.git
   ...
   - cd ../client
   - npm start
   - Open your browser and navigate to http://localhost:3000 to access the Collaborative Whiteboard App.
